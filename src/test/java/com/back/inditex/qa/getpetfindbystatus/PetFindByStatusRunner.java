package com.back.inditex.qa.getpetfindbystatus;
...
public class PetFindByStatusRunner {

    private static final String fs = File.separator;
    private static final String karateEnv = "dev";
    private static final String projectName = "getpetfindbystatus";
    ...
    public void testGetCollectionMethod() {
        ...
        Results result = Runner.path("classpath:com/back/inditex/qa/getpetfindbystatus/get-pet-findByStatus.feature")
